<%@ Page Title="" Language="C#" MasterPageFile="~/Bayi.Master" AutoEventWireup="true" CodeBehind="SiparisEkle1.aspx.cs" Inherits="GuvenliYazilim_VersiyonKontrollu2.SiparisEkle1" %>
                ...
                success: function (response) {
                    ...
                    var obj = JSON.parse(response.d, function (key, value) {
                        ...
                        if (key == "Id") {
                            ...
                            var bas = "<tr><td> <button type='button' class='btn-link' onclick='Delete(" + value + ")'> Sipariş Sil </button>"
                                  + "   </td>";
