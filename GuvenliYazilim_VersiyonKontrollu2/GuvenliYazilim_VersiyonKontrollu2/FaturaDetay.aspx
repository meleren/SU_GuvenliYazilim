<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FaturaDetay.aspx.cs" Inherits="GuvenliYazilim_VersiyonKontrollu2.FaturaDetay" %>
...
<body>
        ...
        <form class="form-horizontal">
            ...
            <div class="form-group">
                <div class="col-sm-offset-2 col-sm-2">
                    <button type="button" id="Faturalandir" class=" btn  btn-lg" style="width: 100%;"> Fatura Sil</button>
                </div>
                <div class="col-sm-offset-2 col-sm-2">
                  
                    <a href='FaturaSorgula1.aspx' class='btn  btn-lg' data-close-btn='right'>Geri</a>
                </div>
         </div>
        </form>
    </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            console.log(id);
            $.ajax({
                url: 'FaturaSorgula1.aspx/GetDetay',
        ...
        $(document).ready(function () {
            $('#Faturalandir').click(function () {
                var id = queryString("Id");
                $.ajax({
                    url: 'FaturaSorgula1.aspx/FaturaSil',
                    contentType: "application/json; charset=utf-8",
                    data: '{ FaturaNo:' + id + '}',
                    dataType: 'json',
                    async: true,
                        ...
                        var obj = JSON.parse(response.d, function (key, value) {
                            ...
                            if (key == "Id") {
                                if (value == 0)
                                    ...
                                    window.location.assign("FaturaSorgula1.aspx");
                                }
                            }
                        });
                    },
